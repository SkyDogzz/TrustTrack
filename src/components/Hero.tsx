...
export default function Hero() {
    return (
        <div className="text-black dark:text-white flex max-w-7xl mx-auto">
            <div className="container mx-auto p-4">
                ...
                <button className="p-2 bg-blue-500 text-white rounded-md dark:bg-blue-900 hover:bg-blue-600 dark:hover:bg-blue-800 active:bg-blue-700 dark:active:bg-blue-700">Démarrer maintenant</button>
            </div>
